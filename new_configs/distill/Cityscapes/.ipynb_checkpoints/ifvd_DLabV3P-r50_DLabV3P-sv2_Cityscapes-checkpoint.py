...
student_cfg_path = 'autodl-tmp/lhf/HRDKD-master/new_configs/deeplabv3+/shufflenet-v2-d8_deeplabv3plus_4xb2-40k_cityscapes-512x1024.py'  # noqa: E501
...
model = dict(
    ...
    distiller=dict(
        ...
        distill_losses=dict(
            loss_ifvd=dict(
                type=CriterionIFV,classes=19,loss_weight=20),
            loss_kl=dict(
                type=CriterionKD,
                loss_weight=1.0)
        ),
...
work_dir='autodl-tmp/lhf/HRDKD-master/work_dir/ifvd_DLabV3P-r50_DLabV3P-sv2_Cityscapes'