...
from razor.models.losses import CriterionPairWiseforWholeFeatAfterPool, CriterionPixelWise,CriterionKD
with read_base():
...
work_dir='autodl-tmp/lhf/HRDKD-master/work_dir/skd_DLabV3P-r50_PSPNet-r18_Cityscapes'