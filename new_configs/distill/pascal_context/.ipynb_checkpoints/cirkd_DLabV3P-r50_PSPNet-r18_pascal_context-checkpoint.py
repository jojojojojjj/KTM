...
student_cfg_path = 'autodl-tmp/lhf/HRDKD-master/new_configs/pspnet/pspnet_r18_d8_4xb4_40k_pascal_context_59_480x480.py'  # noqa: E501
    ...
    distiller=dict(
        ...
        distill_losses=dict(
            ...
            loss_memory=dict(
                ...
                region_contrast_size=120,
                pixel_contrast_size=120,
                pooling=True,
                num_classes=59,
                s_channels=128,
                t_channels=512,
                loss_weight=1.0),
            loss_minibatch=dict(
                type=CriterionMiniBatchCrossImagePair,temperature=1,pooling=False,loss_weight=1),
        ),
...
work_dir='autodl-tmp/lhf/HRDKD-master/work_dir/cirkd_DLabV3P-r50_PSPNet-r18_pascal_context'