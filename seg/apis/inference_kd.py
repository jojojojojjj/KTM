...
from engine.runner.checkpoint import _load_checkpoint_to_model
...
def init_model_kd(config: Union[str, Path, Config],
               checkpoint = None,
               device: str = 'cuda:0',
...
def _preprare_data(imgs: ImageType, model: BaseSegmentor, seg_dir: str):
    ...
    for img in imgs:
        ...
        #print(data_['data_samples'].gt_sem_seg.data.shape)
    return data, is_batch


def inference_model_kd(model: BaseSegmentor,
                    img: ImageType,
    ...
    #print(results[0].gt_sem_seg.data.shape)
