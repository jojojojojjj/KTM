...
class GTKDLoss(nn.Module):
    ...
    def forward(
        ...
        **kwards
        ...
        tckd_loss = self._get_tckd_loss(preds_S, non_gt_mask, gt_mask)
        bckd_loss = self._get_bckd_loss(preds_S, non_gt_mask, gt_mask)
        nckd_loss = self._get_nckd_loss(preds_S, non_gt_mask, gt_mask)
        loss = self.alpha*tckd_loss + self.beta*nckd_loss + self.gama*bckd_loss
